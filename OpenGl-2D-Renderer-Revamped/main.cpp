...
int main(int argc, char** argv) {
	...
	TextOptions options;
	options.font = resService.GetFontByName();
	...
	auto window = std::make_unique<Window>(1, glm::vec2(400, 400), glm::vec2(300, 200), resService.GetBgSkinByName("default"));

	window.get()->AddChild(std::move(label));

	auto label2 = std::make_unique<Label>(txt2, glm::vec2(10.f, 10.f), glm::vec2(200, 50));
	auto window2 = std::make_unique<Window>(2, glm::vec2(450, 380), glm::vec2(300, 200), resService.GetBgSkinByName("default"));
